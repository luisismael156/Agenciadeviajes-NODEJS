...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-02-2020 a las 06:15:48
...
(2, 'asd', 'asd', 'asd'),
(3, 's', 's', 's'),
(4, 'Luis', 'sak', 'Me parece muy buena pagina de viajes, la cual me ayuda mucho a elegir mis destinospara ir me de vacaciones'),
(5, 'hola', 'demo', 'asd'),
(6, 's', 'sa', 'sad'),
(7, 's', 'sa', 'sad');
